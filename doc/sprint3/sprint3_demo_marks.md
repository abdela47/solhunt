...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 4 marks)
  ...
  - SR(N-1).md (Sprint Retrospective) (max 2 marks)
    ...
    Your Mark: 1 (more detail would be nice)
...
Your standup messages should be being sent at the same time by everyone, to show that you're all doing your standups together. 
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 (one member not assigned any tasks)
